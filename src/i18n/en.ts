export default {
  ...
  otpHub: {
    title: 'OTP Hub',
    subtitle: 'Shared account verification codes',
    subscribe: 'Get notified',
    subscribed: 'Subscribed',
    subscribedBanner: 'You will receive push notifications when a new OTP code is available!',
    processing: 'Processing...',
    permissionDenied: 'Notification permission denied',
    subscribeSuccess: 'Subscribed to OTP notifications!',
    unsubscribeSuccess: 'Unsubscribed from OTP notifications',
    subscribeFailed: 'Could not subscribe to notifications',
    ...
    sendOtp: 'Send OTP',
    sending: 'Sending...',
    otpRequired: 'Please enter an OTP code',
    otpSent: 'OTP {service} sent to {count} subscribers',
    otpCreateFailed: 'Could not create OTP',
    otpDeleted: 'OTP deleted',
    otpDeleteFailed: 'Could not delete OTP',
    defaultExpiry: 'Default expiry time',
    minutes: 'min',
    save: 'Save',
    settingsSaved: 'Settings saved',
    settingsFailed: 'Could not save settings',
    subscribersCount: '{count} people subscribed to notifications',
    justNow: 'just now',
    minutesAgo: '{n}m ago',
    hoursAgo: '{n}h ago',
    daysAgo: '{n}d ago',
    expired: 'Expired',
    emptyTitle: 'No OTP codes yet',
