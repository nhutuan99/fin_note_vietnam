...
useAppSeo({
  title: t('otpHub.seoTitle'),
  description: t('otpHub.seoDesc'),
  url: typeof window !== 'undefined' ? window.location.origin + '/otp-hub' : '',
  keywords: t('otpHub.seoKeywords'),
  type: 'website'
})
...
function getBrandSvg(service: string): string {
  switch (service) {
    case 'netflix':
      return `<svg viewBox="0 0 24 24" class="w-full h-full"><path fill="#E50914" d="M5.5 2h3.5v20H5.5zm10 0h3.5v20h-3.5z"/><path fill="#B81D24" d="M9 2h3.5l6.5 20h-3.5z"/></svg>`
    case 'spotify':
      return `<svg viewBox="0 0 24 24" class="w-full h-full"><path fill="#1DB954" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.59 14.4c-.18.3-.58.4-.88.22-2.38-1.46-5.38-1.79-8.91-.98-.34.08-.68-.14-.76-.48-.08-.34.14-.68.48-.76 3.86-.88 7.16-.5 9.85 1.15.3.17.4.57.22.87zm1.23-2.73c-.23.38-.72.5-1.1.27-2.73-1.68-6.9-2.17-10.12-1.19-.43.13-.88-.12-1-.55-.13-.43.12-.88.55-1 3.7-1.12 8.3-.57 11.4 1.34.38.23.5.72.27 1.1zm.11-2.85C14.31 8.5 8.35 8.3 4.9 9.35c-.53.16-1.1-.14-1.26-.67-.16-.53.14-1.1.67-1.26 4.02-1.22 10.6-1 15.2 1.73.48.28.64.9.36 1.38-.28.48-.9.64-1.38.36z"/></svg>`
    case 'youtube':
      return `<svg viewBox="0 0 24 24" class="w-full h-full"><path fill="#FF0000" d="M23.498 6.163a3.003 3.003 0 0 0-2.11-2.11C19.518 3.545 12 3.545 12 3.545s-7.518 0-9.388.507a3.003 3.003 0 0 0-2.11 2.11C0 8.033 0 12 0 12s0 3.967.502 5.837a3.003 3.003 0 0 0 2.11 2.11c1.87.507 9.388.507 9.388.507s7.518 0 9.388-.507a3.003 3.003 0 0 0 2.11-2.11C24 15.967 24 12 24 12s0-3.967-.502-5.837z"/><path fill="#FFFFFF" d="M9.545 15.568V8.432L15.818 12z"/></svg>`
    case 'discord':
      return `<svg viewBox="0 0 24 24" class="w-full h-full"><path fill="#5865F2" d="M20.317 4.37a19.791 19.791 0 0 0-4.885-1.515.074.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0 12.64 12.64 0 0 0-.617-1.25.077.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 4.37a.07.07 0 0 0-.032.027C.533 9.046-.32 13.58.099 18.057a.082.082 0 0 0 .031.057 19.9 19.9 0 0 0 5.993 3.03.078.078 0 0 0 .084-.028 14.09 14.09 0 0 0 1.226-1.994.076.076 0 0 0-.041-.106 13.107 13.107 0 0 1-1.872-.894.077.077 0 0 1-.008-.128c.126-.093.252-.19.372-.287a.075.075 0 0 1 .077-.011c3.92 1.793 8.18 1.793 12.061 0a.073.073 0 0 1 .078.009c.12.099.246.195.373.289a.077.077 0 0 1-.006.127 12.299 12.299 0 0 1-1.873.894.077.077 0 0 0-.041.107c.36.698.772 1.362 1.225 1.993a.076.076 0 0 0 .084.028 19.839 19.839 0 0 0 6.002-3.03.077.077 0 0 0 .032-.054c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 0 0-.031-.03zM8.02 15.33c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.956-2.419 2.156-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.956 2.418-2.156 2.418zm7.975 0c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.955-2.419 2.156-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.946 2.418-2.156 2.418z"/></svg>`
    case 'github':
      return `<svg viewBox="0 0 24 24" class="w-full h-full"><path fill="currentColor" d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12"/></svg>`
    case 'google':
      return `<svg viewBox="0 0 24 24" class="w-full h-full"><path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/><path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/><path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.06H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.94l2.85-2.22.81-.63z"/><path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.06l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"/></svg>`
    case 'facebook':
      return `<svg viewBox="0 0 24 24" class="w-full h-full"><path fill="#1877F2" d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.95c4.56-.93 8-4.96 8-9.75z"/></svg>`
    case 'apple':
      return `<svg viewBox="0 0 24 24" class="w-full h-full"><path fill="currentColor" d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M15.97 4.17c.66-.81 1.11-1.93.99-3.06-.96.04-2.13.64-2.82 1.45-.6.69-1.12 1.83-.98 2.94 1.07.08 2.15-.52 2.81-1.33z"/></svg>`
    case 'steam':
      return `<svg viewBox="0 0 24 24" class="w-full h-full"><path fill="currentColor" d="M12 2a10 10 0 0 0-9.925 8.767l4.636 1.892a3.02 3.02 0 0 1 2.457-.96l2.5-3.6A3.493 3.493 0 1 1 15 11.5l-3.6 2.5a3.02 3.02 0 0 1-3.323 1.884l-4.52 1.84A10 10 0 1 0 12 2zm3 6a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3z"/></svg>`
    default:
      return `<svg viewBox="0 0 24 24" class="w-full h-full" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 2l-2 2m-7.61 7.61a5.5 5.5 0 1 1-7.778 7.778 5.5 5.5 0 0 1 7.777-7.777zm0 0L15.5 7.5m0 0l3 3L22 7l-3-3m-3.5 3.5L19 4"/></svg>`
  }
}
...
<template>
  <div class="mx-auto max-w-[40rem] px-4 pb-24 pt-2">
    ...
    <!-- ── PWA Installation Guide (Collapsible Dropdown) ── -->
    <div class="card-premium rounded-2xl mb-6 overflow-hidden">
      <button
      ...
      >
        <div class="flex items-center gap-2.5">
          ...
          <div class="text-left">
            <span class="text-[0.875rem] font-bold block">{{ t('otpHub.pwaGuideTitle') }}</span>
            <span class="text-text-tertiary text-[0.75rem] font-normal block max-w-[250px] sm:max-w-none truncate">{{ t('otpHub.pwaGuideDesc') }}</span>
          </div>
        </div>
        <component :is="showPwaGuide ? ChevronUp : ChevronDown" :size="16" class="text-text-tertiary" />
      </button>

      <div v-if="showPwaGuide" class="border-t border-border-default px-5 py-4 bg-bg-elevated/40 space-y-4 text-[0.8125rem] text-text-secondary leading-relaxed">
        <!-- iOS Safari -->
        <div class="space-y-2">
          <h4 class="font-bold text-text-primary flex items-center gap-1.5">
            <span class="inline-block w-1.5 h-1.5 rounded-full bg-accent" />
            {{ t('otpHub.pwaIosTitle') }}
          </h4>
          <ol class="list-decimal list-inside pl-1 space-y-1">
            <li v-html="t('otpHub.pwaIosStep1')"></li>
            <li v-html="t('otpHub.pwaIosStep2')"></li>
          </ol>
        </div>
        ...
        <div class="space-y-2 border-t border-border-subtle pt-3">
          <h4 class="font-bold text-text-primary flex items-center gap-1.5">
            ...
            {{ t('otpHub.pwaAndroidTitle') }}
          </h4>
          <ol class="list-decimal list-inside pl-1 space-y-1">
            <li v-html="t('otpHub.pwaAndroidStep1')"></li>
            <li v-html="t('otpHub.pwaAndroidStep2')"></li>
          </ol>
        </div>
      </div>
    </div>
            ...
            <div class="relative" ref="serviceDropdownRef">
              ...
              >
                <div class="flex items-center gap-2">
                  <div
                    class="flex h-5 w-5 items-center justify-center rounded shrink-0 overflow-hidden text-text-primary"
                    :style="{ backgroundColor: getServiceConfig(adminForm.service).color + '20' }"
                  >
                    <span v-html="getBrandSvg(adminForm.service)" class="w-3.5 h-3.5 flex items-center justify-center" />
                  </div>
                  ...
                  <div class="flex flex-col gap-0.5">
                    ...
                    >
                      <div class="flex items-center gap-2 py-0.5">
                        ...
                        >
                          <span v-html="getBrandSvg(s.key)" class="w-3.5 h-3.5 flex items-center justify-center" />
                        </div>
      ...
      <TransitionGroup name="otp-card">
        ...
        >
          ...
          <div class="flex items-center justify-between mb-4">
            <div class="flex items-center gap-2.5">
              <div
                class="flex h-8 w-8 items-center justify-center rounded-lg shrink-0 overflow-hidden text-text-primary"
                :style="{ backgroundColor: getServiceConfig(otp.service).color + '20' }"
              >
                <span v-html="getBrandSvg(otp.service)" class="w-5 h-5 flex items-center justify-center" />
              </div>
